...
def mostrar_Registro(frame_registro):##Aqui debemos poner el frame para organizar lo que va dentro 
  #formulario
  tk.Label(frame_registro, text="Registro", font=("Arial", 17)).grid(row=0, column=0, padx=10, pady=5)

  tk.Label(frame_registro, text="Nombre", bg="#B4CF66").grid(row=2, column=0, padx=14, pady=5)# etiqueta
  entry_nombre = tk.Entry(frame_registro)#cuadro de texto
  entry_nombre.grid(row=2, column=1, padx=14, pady=5)
  ## https://hektorprofe.github.io/python/interfaces-graficas-con-tkinter/widget-label-etiqueta-de-texto/

  tk.Label(frame_registro, text="Pan Frances", bg="#B4CF66").grid(row=4, column=0, padx=14, pady=5)
  entry_pan_frances = tk.Entry(frame_registro)
  entry_pan_frances.grid(row=4, column=1, padx=14, pady=5)
    
  tk.Label(frame_registro, text="Pan Queso", bg="#B4CF66").grid(row=6, column=0, padx=14, pady=5)
  entry_pan_queso = tk.Entry(frame_registro)
  entry_pan_queso.grid(row=6, column=1, padx=14, pady=5)
    
  tk.Label(frame_registro, text="Pancacho", bg="#B4CF66").grid(row=8, column=0, padx=14, pady=5)
  entry_pancacho = tk.Entry(frame_registro)
  entry_pancacho.grid(row=8, column=1, padx=14, pady=5)
  def registrar():
  ...
  boton5.grid(row=9, column=0, padx=18, pady=10)
...
def mostrar_reporteT(frame_individual):
    ...
    tk.Label(frame_individual, text="Nombre del panadero").pack(pady=5)
